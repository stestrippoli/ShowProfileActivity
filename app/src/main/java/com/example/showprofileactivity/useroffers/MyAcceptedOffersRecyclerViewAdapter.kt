...
class MyAcceptedOffersRecyclerViewAdapter(
    private val values: List<Offer>, private val itemClickListener: ItemClickListener
) : RecyclerView.Adapter<MyAcceptedOffersRecyclerViewAdapter.ViewHolder>() {
    ...
    override fun onBindViewHolder(holder: ViewHolder, position: Int) {
        ...
        val creatorText = "Requested by " + item.acceptedUser
